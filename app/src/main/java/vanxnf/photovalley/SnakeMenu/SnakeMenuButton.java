...
public class SnakeMenuButton extends FloatingActionButton {

    private Spring springX, springY;

    private SimpleSpringListener followerListenerX, followerListenerY; // 此为跟踪的回调，当前面一个view移动的时候，此为后面的view，需要更新endValue

    public SnakeMenuButton(Context context) {
        this(context, null);
    }
    public SnakeMenuButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SnakeMenuButton(Context context, AttributeSet attrs, int defStyleAttr) {
